...
namespace TheWorld.Models
{
    public class WorldContextSeedData
    {
        ...
        {
            if (await _userManager.FindByEmailAsync("alexandre.lugand@gmail.com") == null)
            {
                // Add the user      
                var newUser = new WorldUser()
                {
                    Id = "1",
                    UserName = "Alex",
                    Email = "alexandre.lugand@gmail.com",
                    NormalizedEmail = "alexandre.lugand@gmail.com",
                    EmailConfirmed = true,
                };

                await _userManager.CreateAsync(newUser, "71PassWord!");
            }
            ...
            if (!_worldContext.Trips.Any())
            {
                ...
                _worldContext.Trips.Add(worldTrip);
                _worldContext.Stops.AddRange(worldTrip.Stops);
